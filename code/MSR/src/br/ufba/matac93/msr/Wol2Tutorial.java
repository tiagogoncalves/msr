...
public class Wol2Tutorial {
	...
	public static void main(String[] args) throws OWLOntologyCreationException {
		...
		OWLOntology ontology2 = manager2
				.loadOntologyFromOntologyDocument(new File("ontofilmes.owl"));
		...
		// OWLIndividual john =
		// factory2.getOWLNamedIndividual(IRI.create(ontologyIRI + "#John"));
		//
		//
		// // IRI indidualTiago =
		// IRI.create(ontology2.getOntologyID().getOntologyIRI() + "#Tiago");
		//
		// OWLClass classePessoa =
		// manager2.getOWLDataFactory().getOWLClass(IRI.create(ontologyIRI +
		// "#Pessoa"));
		//
		// OWLClassAssertionAxiom axiom1 =
		// factory2.getOWLClassAssertionAxiom(classePessoa, john);
		//
		...
		OWLClass personClass2 = factory2
				.getOWLClass(strPessoa + "Pessoa>", pm2);
		...
		OWLNamedIndividual indMaria = factory2.getOWLNamedIndividual(strPessoa
				+ "Joao>", pm2);
		OWLObjectProperty propConhece = factory2.getOWLObjectProperty(strPessoa
				+ "gosta>", pm2);

		for (OWLNamedIndividual ind : reasoner2.getObjectPropertyValues(
				indMaria, propConhece).getFlattened()) {
